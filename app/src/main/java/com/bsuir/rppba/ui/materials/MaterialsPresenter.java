...
public class MaterialsPresenter extends BasePresenter<MaterialsContract.MaterialsView> implements MaterialsContract.MaterialsPresenter {
    ...
    public void loadMaterialsList() {
        ...
        view.onMaterialsLoaded(materials);
